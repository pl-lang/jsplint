...
describe('Parser', () => {
  ...
  it('deberia fichar todos los tokens de un programa modelo', () => {
    ...
    tokenArray[21].value.should.equal('a es mayor que b')
    ...
    tokenArray[26].value.should.equal('b es mayor que a')
